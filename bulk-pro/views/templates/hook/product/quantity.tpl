...
<form class="defaultForm form-horizontal" action="" method="post" enctype="multipart/form-data" novalidate="">
    <div id="fieldset_0" class="panel">
        <div class="panel-heading">{l s='Edit quantity' mod='ets_productmanager'}: {$product_name|escape:'html':'UTF-8'}</div>
        <div class="form-wrapper">
            {if $stock_availables}
                <div class="stock-list">
                    <table class="table">
                        <thead id="stock_thead" class="thead-default">
                            <tr>
                        ...
                        <tbody>
                            {foreach from=$stock_availables item='stock_available'}
                                <tr>
                                    <td>{$stock_available.name|escape:'html':'UTF-8'}</td>
                                    <td>
                                        <input type="text" class="form-control" name="quantities[{$stock_available.id_product_attribute|intval}]" value="{$stock_available.quantity|intval}"/>
                                    </td>
                                </tr>
                            {/foreach}
                        </tbody>
        ...
        <div class="panel-footer">
            ...
            <button id="module_form_submit_btn" class="btn btn-default pull-right" type="submit" value="1" name="submitQuanittyProduct">
