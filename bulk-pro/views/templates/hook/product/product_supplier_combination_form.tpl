            ...
            <div>
                <table class="table">
                    <thead class="thead-default">
                        <tr>
                            <th width="30%">{l s='Product name' mod='ets_productmanager'}</th>
                            <th width="30%">{l s='Supplier reference' mod='ets_productmanager'}</th>
                            <th width="20%">{l s='Price (tax excl.)' mod='ets_productmanager'}</th>
                            <th width="20%">{l s='Currency' mod='ets_productmanager'}</th>
                        </tr>
                    </thead>
                    <tbody>
