...
*}
<form class="defaultForm form-horizontal etspm-form-available-carriers" action="" method="post" enctype="multipart/form-data" novalidate="">
    <div id="fieldset_0" class="panel">
        <div class="panel-heading">{l s='Edit Available carriers' mod='ets_productmanager'}: {$product_name|escape:'html':'UTF-8'}</div>
        <div class="form-wrapper">
            <div class="form-group form-group-available-carriers">
                <div class="available-carrier-chooses">
                    {if $carriers}
