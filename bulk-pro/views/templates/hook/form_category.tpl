...
<form class="defaultForm form-horizontal" action="" method="post" enctype="multipart/form-data" novalidate="">
    <div id="fieldset_0" class="panel">
        <div class="panel-heading">{l s='Edit categories' mod='ets_productmanager'}: {$product_name|escape:'html':'UTF-8'}</div>
        ...
        <div class="panel-footer">
            ...
            <button id="module_form_submit_btn" class="btn btn-default pull-right" type="submit" value="1" name="submitCategoryProduct">
