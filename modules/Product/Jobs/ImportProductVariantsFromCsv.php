...
use Modules\Product\Services\Csv\CsvVariantBulkUpdateService;

class ImportProductVariantsFromCsv implements ShouldQueue
{
    ...
    public function handle(CsvReaderService $reader, CsvVariantBulkUpdateService $bulkUpdate): void
    {
