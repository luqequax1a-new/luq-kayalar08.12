<section class="bottom-navigation-wrap d-lg-none">
    <div class="container">
        <ul class="bottom-navigation-items">
            ...
            <li>
                <a href="{{ route('account.wishlist.index') }}" class="wishlist {{ request()->routeIs('account.wishlist.index') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <span>{{ trans('storefront::layouts.wishlist') }}</span>

                    <span class="count" x-text="$store.wishlist.count">{{ $wishlistCount }}</span>
                </a>
            </li>
