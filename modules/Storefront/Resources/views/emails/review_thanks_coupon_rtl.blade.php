            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;background:#ffffff;">
                ...
                <tr>
                    <td style="padding:24px 15px;background:#ffffff;text-align:center;">
                        <h2 style="font-family:'Open Sans',sans-serif;font-size:22px;color:#0f172a;margin:0 0 10px;">{{ $order->customer_first_name }} {{ $order->customer_last_name }}, كوبونك جاهز!</h2>
                        <p style="font-family:'Open Sans',sans-serif;font-size:15px;color:#334155;margin:0 0 18px;">
                            رأيك مهم جدًا لنا، فهو يساعدنا على تحسين منتجاتنا وخدماتنا باستمرار.
                        </p>
                        ...
                        <div style="padding:18px;border:1px dashed #cbd5e1;border-radius:12px;background:#f8fafc;margin-bottom:20px;max-width:560px;width:100%;margin-left:auto;margin-right:auto;text-align:center;">
                            <div style="display:inline-block;font-family:'Open Sans',sans-serif;font-size:12px;color:#075985;background:#e0f2fe;padding:8px 12px;border-radius:8px;margin-bottom:12px;font-weight:700;">ملاحظة: القسيمة للاستخدام مرة واحدة.</div>
                            <div style="font-family:'Open Sans',sans-serif;font-size:20px;color:#0f172a;font-weight:800;">القسيمة</div>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="margin-top:12px;">
                                <tr>
                                    <td style="font-family:'Open Sans',sans-serif;font-size:14px;color:#0f172a;white-space:nowrap;">
                                        🔖 نسبة الخصم: <strong>%{{ (int) ($coupon->value) }}</strong>
                                    </td>
                                    <td style="width:16px;"></td>
                                    <td style="font-family:'Open Sans',sans-serif;font-size:14px;color:#0f172a;white-space:nowrap;">
                                        🗓️ صالح حتى: {{ optional($coupon->end_date)->format('Y-m-d') }}
                                    </td>
                                </tr>
                            </table>
                        </div>
