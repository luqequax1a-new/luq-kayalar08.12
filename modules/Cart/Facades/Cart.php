 ...
 * @method static void store(int $productId, int $variantId, float $qty, array $options = [], array $variations = [])
 * @method static void updateQuantity(string $id, float $qty)
 * @method static CartCollection items()
 * @method static float addedQty(\Modules\Cart\CartItem $cartItem)
